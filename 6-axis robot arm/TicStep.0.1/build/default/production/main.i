...
__asm("\tpsect eeprom_data,class=EEDATA,noexec"); __asm("\tdb\t" "0x01" "," "0" "," "0" "," "0" "," "0" "," "0" "," "0" "," "0");
...
# 414 "main.c"
    while (1)
    {
        ...
        if (limit_mode & 0x01)
            if ( ((limit_mode & 0x02) &&
                  ((dirbit && PORTBbits.RB0) || (!dirbit && PORTBbits.RB1))) ||
                 (!(limit_mode & 0x02) &&
                  ((dirbit && !PORTBbits.RB0) || (!dirbit && !PORTBbits.RB1)))
               )
            {
                stop_motion();
                if ( limit_mode & 0x04 ) do { LATAbits.LATA1 = 1; } while(0);
            }
