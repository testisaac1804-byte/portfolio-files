...
# 57 "mcc_generated_files/tmr0.h" 2
...
volatile uint16_t PathBuffer[127];
...
void TMR0_ISR(void)
{
    ...
    else
    {
        ...
        if ( *((uint8_t *)(PathBuffer+PathTail)+1)==0 )
        {
        ...
        else
        {
            ...
            T1CONbits.T1CKPS1 = 0;
            timer1ReloadVal = PathBuffer[PathTail];
        }
